...
#gs = GridSpec(4, 2, figure=fig, width_ratios=[1, 1, 1, 0.2], hspace=0.3, wspace=0.3)

# Create subplot axes
rows = 2
fig, axes = plt.subplots(rows, len(model_checkpoints)//rows,  figsize=(10, 20))
...
plt.savefig("../figures/six_models_comparison.pdf", dpi=400, bbox_inches='tight')
plt.savefig("../figures/six_models_comparison.png", dpi=400, bbox_inches='tight')
plt.savefig("../figures/six_models_comparison.svg", dpi=400, bbox_inches='tight')
